# Contributing to exponential-moving-average

First and foremost, thank you! We appreciate that you want to contribute to exponential-moving-average, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for exponential-moving-average**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for exponential-moving-average:

- star the [project](https://github.com/jonschlinkert/exponential-moving-average)
- tweet your support for exponential-moving-average
...
- **version**: please note the version of exponential-moving-average are you using
...
[so]: http://stackoverflow.com/questions/tagged/exponential-moving-average